...
function App() {
  ...
  function handleUpdateUser(data) {
    api
      .loadingUserInfoOnServer({ name: data.name, about: data.about })
      .then((result) => {
        setCurrentUser(result);
        closeAllPopups();
      })
    ...
    <CurrentUserContext.Provider value={currentUser}>
      <div className="page">
        <InfoTooltip
          ...
          isOpen={isInfoTooltip ? "popup_opened" : ""}
        />
        <EditProfilePopup
        ...
        <PopupWithForm
          type="deletion"
          isOpen={isEditAgreePopupOpen ? "popup_opened" : ""}
          name="formAgree"
          title="Вы уверены?"
          text="Да"
        />
