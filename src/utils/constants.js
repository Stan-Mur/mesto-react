...
export const openEditProfilePopupBtn = document.querySelector(
  ".profile-info__edit-button"
);
export const openAddCardPopupBtn = document.querySelector(
  ".profile__add-button"
);
export const openRedactAvatarPopupBtn = document.querySelector(
  ".profile-avatar__redact-button"
);
export const popupProfileRedact = document.querySelector(".popup_type_redact");
export const popupAvatarRedact = document.querySelector(
  ".popup_type_redact-avatar"
);
